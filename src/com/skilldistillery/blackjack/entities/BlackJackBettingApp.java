...
public class BlackJackBettingApp {
	...
	public void dealerTurn() {
		...
		if (dealer.dealerHand.isBlackJack()) {
			System.out.println("\n********** Dealer Blackajack **********");
			if (player.playerHand.getHandValue() < 21 || player.playerHand.getHandValue() > 21) {
				dealer.dealerWin();
